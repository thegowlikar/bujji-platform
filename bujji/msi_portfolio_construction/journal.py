"""PortfolioConstructionJournal — append-only audit trail, mirroring
...
class PortfolioConstructionJournal:
    def __init__(self) -> None:
        self._entries: List[JournalEntry] = []

    def record_assessment(self, assessment: PortfolioConstructionAssessment, *, recorded_at: str) -> None:
