"""PositionConstructionJournal — append-only audit trail, mirroring
...
class PositionConstructionJournal:
    def __init__(self) -> None:
        self._entries: List[JournalEntry] = []

    def record_assessment(self, assessment: PositionConstructionAssessment, *, recorded_at: str) -> None:
