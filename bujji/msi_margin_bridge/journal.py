"""MarginBridgeJournal — append-only audit trail, mirroring every prior
...
class MarginBridgeJournal:
    def __init__(self) -> None:
        self._entries: List[JournalEntry] = []

    def record_assessment(self, assessment: MarginEstimate, *, recorded_at: str) -> None:
