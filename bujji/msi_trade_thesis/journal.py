"""TradeThesisJournal — append-only audit trail, mirroring every prior
MSI package's journal convention."""
...
class TradeThesisJournal:
    def __init__(self) -> None:
        self._entries: List[JournalEntry] = []

    def record_assessment(self, assessment: TradeThesisAssessment, *, recorded_at: str) -> None:
