"""Deterministic JSON round-trip for MarketDirectionAssessment, reusing
established conventions (explicit key ordering, no uuid4, no wall
clock) from bujji.msi_price_structure.serialization / bujji.msi_consensus.serialization.
"""
...
def lens_opinion_to_dict(lo: LensOpinion) -> Dict[str, Any]:
    return {
        ...
        "directional_lean": lo.directional_lean,
...
def lens_opinion_from_dict(d: Dict[str, Any]) -> LensOpinion:
    return LensOpinion(
        ...
        directional_lean=d["directional_lean"],
...
def explanation_to_dict(e: Explanation) -> Dict[str, Any]:
    return {
        ...
        "why_not_a_simple_vote": e.why_not_a_simple_vote,
...
def explanation_from_dict(d: Dict[str, Any]) -> Explanation:
    return Explanation(
        ...
        why_not_a_simple_vote=d["why_not_a_simple_vote"],
        schema_version=d["schema_version"],
    )


def assessment_to_dict(a: MarketDirectionAssessment) -> Dict[str, Any]:
    return {
        "assessment_id": a.assessment_id,
        "timestamp": a.timestamp,
        "overall_direction": a.overall_direction,
...
def assessment_from_dict(d: Dict[str, Any]) -> MarketDirectionAssessment:
...
def assessment_to_json(a: MarketDirectionAssessment) -> str:
    return json.dumps(assessment_to_dict(a), sort_keys=True, default=repr)


def assessment_from_json(text: str) -> MarketDirectionAssessment:
