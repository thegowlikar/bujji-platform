"""PositionLifecycleJournal — append-only audit trail, mirroring every
...
class PositionLifecycleJournal:
    ...
    def record_assessment(self, assessment: PositionLifecycleAssessment, *, recorded_at: str) -> None:
