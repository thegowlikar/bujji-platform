...
class TestEntryPriceIsNeverMarketPrice:
    ...
    def test_the_deprecated_adapter_returns_empty_not_entry_prices(self):
        body = ast.unparse(_fn("_current_leg_prices"))
        assert "dict(self._entry_prices)" not in body, (
            "the compatibility adapter reintroduced the substitution")
